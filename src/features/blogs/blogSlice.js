...
// Reset State: reseting  the loading, isSuccessful, CreatedState to default
// after making API calls to avoid repetition and append to the end of the extraReducers
...
export const blogSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(resetState, () => initialState); // attached to the extra reducer to clear the state and return it to default
  },
});
